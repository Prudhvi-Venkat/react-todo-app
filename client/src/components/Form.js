    ...
    <>
      <form className="flex flex-col space-y-5 p-10" onSubmit={handleSubmit}>
        <div className="flex flex-col p-10 justify-center items-center space-x-5 w-full bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 mx-auto">
          <h2 className="text-center text-xl font-bold text-gray-600 mt-5 mb-5">
            Add Item
          </h2>
          ...
          <div className="flex justify-center items-center mx-auto">
            <button
              ...
              className="text-white w-full bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
            >
              Add
            </button>
          </div>
