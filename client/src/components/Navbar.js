        ...
        <div className="container justify-between flex flex-wrap items-center mx-auto">
          ...
          <div className="flex md:order-2 space-x-3 items-center">
            ...
            <div className="flex md:order-2 items-center justify-center space-x-3">
              <button
                type="button"
                className="text-white font-semibold shadow-lg bg-pale hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-md text-sm px-5 py-2.5 mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                Login
              </button>
              {/* <button
